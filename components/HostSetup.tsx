                        ...
                        <div className="bg-white p-4 rounded-Nonecard shadow-sm border border-line">
                            ...
                            <div className="flex items-center gap-3 p-3 bg-surface-muted rounded-Nonecontrol border border-line">
                                ...
                                <div>
                                    ...
                                    <p className="text-caption text-ink-soft">{currentUser.service}</p>
                                </div>
                            </div>
                            <p className="text-caption text-ink-soft mt-2">Visitors will see your NikoSoko profile details when they scan your door.</p>
                        </div>
                    </div>
                )}
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-caption text-ink-soft">{status === 'Do Not Disturb' ? 'Visitors cannot ring doorbell' : 'Visitors can ring doorbell'}</p>
                                </div>
                            </div>
