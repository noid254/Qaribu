            ...
            <main className="flex-1 flex flex-col justify-center items-center p-6 space-y-6">
                ...
                <div className="w-full space-y-5">
                    ...
                    >
                        ...
                        <p className="text-body text-ink-soft mt-1">Sell a physical item in the marketplace.</p>
                    </button>
                    ...
                    >
                        ...
                        <p className="text-body text-ink-soft mt-1">Offer your skills with a new service card.</p>
                    </button>
                </div>
            </main>
        </div>
